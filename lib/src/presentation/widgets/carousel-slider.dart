...
class MyGymCarouselSlider extends StatefulWidget {
  MyGymCarouselSlider(
  ...
  /// The initial page to show when first creating the [MyGymCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [MyGymCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [MyGymCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [MyGymCarouselSlider].
  ///
  ...
  /// Animates the controlled [MyGymCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _MyGymCarouselSliderState createState() => _MyGymCarouselSliderState();
}

class _MyGymCarouselSliderState extends State<MyGymCarouselSlider>
